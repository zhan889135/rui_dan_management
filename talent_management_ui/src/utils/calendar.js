...
const calendar = {
  ...
  // 计算工时 - 小时
  calculateWorkingHours(startDateStr, endDateStr) {
    ...
    while (current <= end) {
      ...
      const tag = this.compensatoryLeave?.[y]?.[dateStr];

      const isHoliday = tag === '休';
      const isMakeupWorkday = tag === '班';

      if ((!isWeekend && !isHoliday) || (isWeekend && isMakeupWorkday)) {
  ...
  compensatoryLeave:{
    2025: {
      '2025-01-01': '休',  // 元旦节
      '2025-01-26': '班',  // 春节调休上班
      '2025-01-28': '休',  // 春节假期开始（除夕）
      '2025-01-29': '休',  // 春节假期开始（除夕）
      '2025-01-30': '休',  // 春节假期开始（除夕）
      '2025-01-31': '休',  // 春节假期开始（除夕）
      '2025-02-01': '休',  // 春节假期开始（除夕）
      '2025-02-02': '休',  // 春节假期开始（除夕）
      '2025-02-03': '休',  // 春节假期开始（除夕）
      '2025-02-04': '休',  // 春节假期结束（正月初七）
      '2025-02-08': '班',  // 春节调休上班
      '2025-04-04': '休',  // 清明节
      '2025-04-05': '休',  // 清明节
      '2025-04-06': '休',  // 清明节假期结束
      '2025-04-27': '班',  // 劳动节调休上班
      '2025-05-01': '休',  // 劳动节
      '2025-05-02': '休',  // 劳动节
      '2025-05-03': '休',  // 劳动节
      '2025-05-04': '休',  // 劳动节
      '2025-05-05': '休',  // 劳动节假期结束
      '2025-05-31': '休',  // 端午节
      '2025-06-01': '休',  // 端午节假期结束
      '2025-06-02': '休',  // 端午节假期结束
      '2025-09-28': '班',  // 国庆节调休上班
      '2025-10-01': '休',  // 国庆节
      '2025-10-02': '休',  // 国庆节
      '2025-10-03': '休',  // 国庆节
      '2025-10-04': '休',  // 国庆节
      ...
      '2025-10-06': '休',  // 国庆节
      '2025-10-07': '休',  // 国庆节
      '2025-10-08': '休',  // 国庆节假期结束
      '2025-10-11': '班',  // 国庆节调休上班
    }
  },
