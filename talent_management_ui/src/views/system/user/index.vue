          ...
          <el-col>
            <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="80px">
              ...
              <el-form-item label="状态" prop="status">
                <el-select v-model="queryParams.status" placeholder="用户状态" clearable style="width: 240px" @change="handleQuery">
            ...
            <div class="table-wrapper-self">
              <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" stripe>
                ...
                <el-table-column label="登录账号" align="center" key="userName" prop="userName" v-if="columns[1].visible" :show-overflow-tooltip="true" width="140"/>
                <el-table-column label="用户昵称" align="center" key="nickName" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" width="140"/>
                <el-table-column label="部门" align="center" key="deptName" prop="deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" width="150"/>
                <el-table-column label="手机号码" align="center" key="phoneNumber" prop="phoneNumber" v-if="columns[4].visible" width="150"/>
                <el-table-column label="邮箱" align="center" key="email" prop="email" v-if="columns[5].visible" width="220"/>
                <el-table-column label="身份证号" align="center" key="idNumber" prop="idNumber" v-if="columns[6].visible" width="200"/>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        deptId: [
          { required: true, message: "归属供应商不能为空", trigger: "change" }
        ],
        // roleIds: [
